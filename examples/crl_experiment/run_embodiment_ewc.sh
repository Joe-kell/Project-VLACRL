#!/bin/bash
### Usage: bash examples/crl_experiment/run_embodiment_ewc.sh TASK_ID_OR_RANGE [CHECKPOINT_PATH] [MAX_EPOCH] [CONFIG_NAME] [SEED]
### Example (single task): bash examples/crl_experiment/run_embodiment_ewc.sh 0
### Example (task range): bash examples/crl_experiment/run_embodiment_ewc.sh "0,3"
### Example (with max_epoch): bash examples/crl_experiment/run_embodiment_ewc.sh 0 "" 15
### Example (continue from checkpoint): bash examples/crl_experiment/run_embodiment_ewc.sh 0 ./logs/ewc/task_0_seed1234/checkpoints/global_step_10/actor 20
### Example (with seed): bash examples/crl_experiment/run_embodiment_ewc.sh 0 "" "" "" 42
