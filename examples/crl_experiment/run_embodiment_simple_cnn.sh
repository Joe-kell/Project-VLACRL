...
#
# Usage: ./examples/crl_experiment/run_embodiment_simple_cnn.sh [TASK_ID_OR_RANGE] [CHECKPOINT_PATH] [MAX_EPOCH] [CONFIG_NAME] [SEED]
# Example (single task): ./examples/crl_experiment/run_embodiment_simple_cnn.sh 0
# Example (task range): ./examples/crl_experiment/run_embodiment_simple_cnn.sh "0,3"
# Example (with max_epoch): ./examples/crl_experiment/run_embodiment_simple_cnn.sh 0 "" 15
# Example (continue from checkpoint): ./examples/crl_experiment/run_embodiment_simple_cnn.sh 0 ./logs/simple_cnn/task_0_seed1234/checkpoints/global_step_10/actor/model.pt 20
# Example (with seed): ./examples/crl_experiment/run_embodiment_simple_cnn.sh 0 "" "" "" 42
