...
# Base log directory
BASE_LOG_DIR="${REPO_PATH}/logs/libero_spatial/bcrl_logit/03/seed_7"
...
PREV_CHECKPOINT_PATH="./logs/libero_spatial/bcrl_logit/03/seed_7/task_2/checkpoints/global_step_10/actor/"
