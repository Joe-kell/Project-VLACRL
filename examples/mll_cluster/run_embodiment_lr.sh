#!/bin/bash
### Usage: bash examples/mll_cluster/run_embodiment_lr.sh TASK_ID_OR_RANGE [LR_STRING] [CONFIG_NAME] [SEED]
### Example (single task): bash examples/mll_cluster/run_embodiment_lr.sh 0
### Example (task range): bash examples/mll_cluster/run_embodiment_lr.sh "0,3"
### Example (with LR): bash examples/mll_cluster/run_embodiment_lr.sh "1,4" "2e-6,2e-6,1e-5"
### Example (with config): bash examples/mll_cluster/run_embodiment_lr.sh "0,2" "2e-6,2e-6,1e-5" mll_cluster/libero_spatial_grpo_openvlaoft_lr
### Example (with seed): bash examples/mll_cluster/run_embodiment_lr.sh "0,2" "" "" 42
